//! Variants of the [`svg::rsx!`](crate::svg::rsx!) macro.

/// Generates SVG using [`svg::rsx!`](crate::svg::rsx!) syntax, borrowing
/// the environment.
///
/// This is identical to [`svg::rsx!`](crate::svg::rsx!), except that it
...
pub use hypertext_macros::svg_rsx_borrow as borrow;
/// Generates static SVG using [`svg::rsx!`](crate::svg::rsx!) syntax.
///
...
/// );
/// ```
pub use hypertext_macros::svg_rsx_simple as simple;
