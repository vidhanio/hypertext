//! Variants of the [`mathml::rsx!`](crate::mathml::rsx!) macro.

/// Generates MathML using [`mathml::rsx!`](crate::mathml::rsx!) syntax,
/// borrowing the environment.
///
/// This is identical to [`mathml::rsx!`](crate::mathml::rsx!), except that
...
pub use hypertext_macros::mathml_rsx_borrow as borrow;
/// Generates static MathML using [`mathml::rsx!`](crate::mathml::rsx!)
/// syntax.
///
...
/// );
/// ```
pub use hypertext_macros::mathml_rsx_simple as simple;
