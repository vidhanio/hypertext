...
use super::Many;
use crate::{AnyBlock, Context, Generate, Generator};
...
pub struct If<C: Context> {
    ...
    pub cond: Expr,
    pub then_block: ControlBlock<C>,
    pub else_branch: Option<(Token![else], Box<ControlIfOrBlock<C>>)>,
}
